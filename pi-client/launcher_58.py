#!/usr/bin/env python3
"""Boot menu for .58 — WiFi setup if needed, then choose which app to launch.
Variant of launcher.py without the Twitch entry."""
import os
import subprocess
import sys
import threading
...
PY      = sys.executable
SERVICE = "minitelnet-client-58.service"
